  ...
  return (
    <div className="scatter-component">
      ...
      <ScatterChart width={900} height={400}  margin={{ top: 20, right: 0, bottom: 20, left: 30 }}>
        ...
        <YAxis tick={{fontSize: 20}} dataKey="y" type="number" name={featureY} label={{ value: getAxisLabel(featureY), angle: -90, position: 'insideLeft', offset: -20, dy:100 , fontSize:20}}/>
        <Tooltip />
        <Scatter
          data={data}
          fill="#8884d8"
