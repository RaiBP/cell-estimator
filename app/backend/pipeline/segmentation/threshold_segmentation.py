...
class ThresholdSegmentation(Segmentation):
    def __init__(self, global_threshold=5, regional_threshold=None, global_kernel_size=23, regional_kernel_size=13, pixel_to_length_ratio = np.sqrt(0.08), volume_threshold=10, use_phase_global_thresholding=False, use_phase_regional_thresholding=False):
    ...
    def _segment_single_image(self, phase, amplitude):
        ...
        # TODO: convert this final_mask to a list of mask of each individual region
